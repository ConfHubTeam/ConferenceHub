export default function BookingStatsCards({ stats, userType }) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-6 sm:mb-8">
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4">
        <div className="flex items-center">
          ...
          <div className="ml-2 sm:ml-4 min-w-0 flex-1">
            <div className="text-xs sm:text-sm font-medium text-yellow-800 truncate">Pending</div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-2 sm:ml-4 min-w-0 flex-1">
            <div className="text-xs sm:text-sm font-medium text-green-800 truncate">
              {userType === "client" ? "Confirmed" : "Approved"}
            </div>
            <div className="text-lg sm:text-2xl font-bold text-green-900">{stats.approved}</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4">
        <div className="flex items-center">
          ...
          <div className="ml-2 sm:ml-4 min-w-0 flex-1">
            <div className="text-xs sm:text-sm font-medium text-red-800 truncate">Rejected</div>
            <div className="text-lg sm:text-2xl font-bold text-red-900">{stats.rejected}</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
        <div className="flex items-center">
          ...
          <div className="ml-2 sm:ml-4 min-w-0 flex-1">
            <div className="text-xs sm:text-sm font-medium text-blue-800 truncate">Total</div>
