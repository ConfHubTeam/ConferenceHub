 ...
 * 
 * Shows appropriate notifications based on user role with internationalization support.
 * 
 * Single Responsibility: Only handles role-based notifications
    ...
    return (
      <div className="mb-4 p-4 bg-green-50 rounded-lg border border-green-200">
        <div className="flex items-center">
          ...
          <p className="text-green-800 font-medium">{t("booking:roleNotifications.owner.title")}</p>
        </div>
        <p className="text-green-700 text-sm mt-1">{t("booking:roleNotifications.owner.description")}</p>
      </div>
    );
  }
    ...
    return (
      <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div className="flex items-center">
          ...
          <p className="text-blue-800 font-medium">{t("booking:roleNotifications.agent.title")}</p>
        </div>
        <p className="text-blue-700 text-sm mt-1">{t("booking:roleNotifications.agent.description")}</p>
      </div>
    );
  }
    ...
    return (
      <div className="mb-4 p-4 bg-purple-50 rounded-lg border border-purple-200">
        <div className="flex items-center">
          ...
          <p className="text-purple-800 font-medium">{t("booking:roleNotifications.host.title")}</p>
        </div>
        <p className="text-purple-700 text-sm mt-1">{t("booking:roleNotifications.host.description")}</p>
      </div>
    );
  }
