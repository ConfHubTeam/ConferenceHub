...
export default function PlacesFormPage() {
  ...
  function inputHeader(text, isRequired = false) {
    return (
      <h2 className="text-heading-3 text-text-primary mb-2 flex items-center">
        {text}
  ...
  function inputDescription(text) {
    return text ? <p className="text-caption text-text-secondary mb-3">{text}</p> : null;
  }
  ...
  return (
    <div className="bg-bg-primary min-h-screen">
      <div className="spacing-container w-full max-w-none">
        
        {/* Sticky Error Notification */}
        {error && (
          <div className="fixed top-20 left-0 right-0 bg-status-error/10 text-status-error p-4 mb-4 border-b border-status-error/20 shadow-md z-40">
            <div className="max-w-none mx-auto spacing-container flex items-center justify-between">
              ...
              <button 
                onClick={() => setError("")}
                className="ml-4 text-status-error hover:text-status-error/80 flex-shrink-0 transition-colors"
        ...
        <form onSubmit={savePlace} className={`spacing-section w-full ${error ? 'pt-20 sm:pt-24' : ''}`}>
          
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-heading-1 text-text-primary mb-2">
              {id ? t('places:placeEdit.title', 'Edit Place') : t('places:placeCreate.title', 'Create New Place')}
            </h1>
          </div>
          ...
          {user?.userType === 'agent' && (
            <div className="card-base mb-6">
              <div className="card-content">
                <h3 className="text-heading-3 text-text-primary mb-2">{t('places:placeCreate.hostSelector.title')}</h3>
          ...
          <div className="card-base mb-6">
            <div className="card-content">
              <AddressSection
                ...
                preInput={(headerKey, descriptionKey, isRequired = false) => preInput(headerKey, descriptionKey, true)} // Force required for main section
          ...
          <div className="card-base mb-6">
            <div className="card-content">
              {preInput("places:placeCreate.description", null, true)}
              <textarea
                value={description}
          ...
          <div className="card-base mb-6">
            <div className="card-content">
              {preInput("places:placeCreate.extraInfo", null, true)}
              <textarea
                value={extraInfo}
          ...
          <div className="card-base mb-6">
            <div className="card-content">
              <h2 className="text-heading-3 text-text-primary mb-2 flex items-center">
                {t('places:placeCreate.scheduleAvailability.title', 'Schedule & Availability')}
              ...
              <AvailabilitySection
                ...
                preInput={(headerKey, descriptionKey, isRequired = false) => preInput(headerKey, descriptionKey, false)} // Force no required for sub-elements
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-start gap-4 mt-6">
            <button 
              ...
              className="btn-outline btn-size-lg order-2 sm:order-1"
            >
            ...
            <button 
              type="submit"
              className="btn-primary btn-size-lg order-1 sm:order-2"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
