...
export default function FavoritesPage() {
    ...
    const { favorites, clearAllFavorites, favoritesCount, loading, error } = useFavorites();
    ...
    // Don't show favorites page for hosts or agents
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="flex items-center justify-between mb-3">
                                                    ...
                                                    <div className="flex items-center text-sm text-gray-600">
                                                        ...
                                                        <span>
                                                            {place.averageRating || getPlaceRatingDisplay(place, t)}
                                                        </span>
